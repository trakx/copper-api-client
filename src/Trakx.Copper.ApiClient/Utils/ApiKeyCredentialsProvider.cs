...
namespace Trakx.Copper.ApiClient.Utils
{
    ...
    {
        internal const string ApiKeyHeader = "COPPER-API-KEY";
        internal const string ApiNonceHeader = "COPPER-API-NONCE";
        internal const string ApiSignatureHeader = "COPPER-API-SIGNATURE";
