...
namespace Trakx.Copper.ApiClient
{
    ...
    /// <summary>The account object contains information about an exchange account that you have linked to your Copper account.</summary>
    ...
    /// <summary>A unique identifier for the exchange that is used with other Copper endpoints. This is typically the lowercase name of the exchange without spaces.</summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.1.0 (Newtonsoft.Json v12.0.0.0)")]
